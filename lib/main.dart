...
import 'package:project/telas/deletarconta_tela.dart';
...
class MenuTela extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (_) => DeletarContaTela()),
              );
            },
          ),
        ],
              ...
              children: [
                GestureDetector(
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => MapaTela()),
                  ),
                  child: menuCard(
                    Colors.blue,
                    Icons.map,
                ...
                GestureDetector(
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => ParadasTela()),
                  ),
                  child: menuCard(
                    Colors.deepPurple,
                    Icons.location_on,
                ...
                GestureDetector(
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => BuscarLinhasTela()),
                  ),
                  child: menuCard(
                    Colors.lightBlue,
                    Icons.search,
  ...
  Widget menuCard(Color cor, IconData icone, String titulo, String subtitulo) {
    return Container(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  Center(
                    child: Container(width: 60, height: 5, color: Colors.grey),
                  ),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            paradaCard('Praça da Matriz', '350m de distância'),

            paradaCard('Terminal Central', '500m de distância'),

            paradaCard('Shopping Center', '900m de distância'),
          ],
        ),
      ),
    );
